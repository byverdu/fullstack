    ...
    for (const L of Q)
      if (L.type === 'childList')
        for (const tl of L.addedNodes)
          tl.tagName === 'LINK' && tl.rel === 'modulepreload' && r(tl);
...
function Dd() {
  ...
  function $(r, Q, L) {
    ...
    if (
      (L !== void 0 && (tl = '' + L),
      Q.key !== void 0 && (tl = '' + Q.key),
      'key' in Q)
    ) {
      L = {};
      for (var ql in Q) ql !== 'key' && (L[ql] = Q[ql]);
    } else L = Q;
    return (
      (Q = L.ref),
      { $$typeof: D, type: r, key: tl, ref: Q !== void 0 ? Q : null, props: L }
    );
  }
  return ((me.Fragment = sl), (me.jsx = $), (me.jsxs = $), me);
}
var kv;
function Ud() {
  return (kv || ((kv = 1), (kc.exports = Dd())), kc.exports);
}
var Sa = Ud(),
  Fc = { exports: {} },
  X = {};
...
function Rd() {
  ...
  function Vl(s, E, _, z, N, J) {
    return (
      (_ = J.ref),
      { $$typeof: D, type: s, key: E, ref: _ !== void 0 ? _ : null, props: J }
    );
  }
  function Ll(s, E) {
  ...
  function Ul(s, E, _, z, N) {
    ...
    if (yt(s))
      for (var cl = 0; cl < s.length; cl++)
        ((z = s[cl]), (J = Kl + Dl(z, cl)), (G += Ul(z, E, _, J, N)));
    else if (((cl = el(s)), typeof cl == 'function'))
      for (s = cl.call(s), cl = 0; !(z = s.next()).done; )
        ((z = z.value), (J = Kl + Dl(z, cl++)), (G += Ul(z, E, _, J, N)));
    else if (J === 'object') {
...
var Iv;
function ui() {
  return (Iv || ((Iv = 1), (Fc.exports = Rd())), Fc.exports);
}
var Se = ui(),
  Ic = { exports: {} },
  re = {},
        ...
        function yt(g) {
          for (var O = $(A); O !== null; ) {
            if (O.callback === null) r(A);
              ...
              (r(A), (O.sortIndex = O.expirationTime), sl(H, O));
            else break;
            O = $(A);
          }
        }
              ...
              l: {
                ...
                try {
                  t: {
                    for (
                      yt(g), fl = $(H);
                      fl !== null && !(fl.expirationTime > g && Nu());
...
var ly;
function Nd() {
  return (ly || ((ly = 1), (Pc.exports = Hd())), Pc.exports);
}
var ti = { exports: {} },
  Nl = {};
/**
...
function qd() {
  ...
  var tl = D.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function ql(H, A) {
    if (H === 'font') return '';
  ...
  return (
    ...
    (Nl.useFormState = function (H, A, R) {
      return tl.H.useFormState(H, A, R);
    }),
...
function Yd() {
  ...
  return (D(), (ti.exports = qd()), ti.exports);
}
/**
 * @license React
...
function Bd() {
  ...
  var Ul = Array.isArray,
    g = sl.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  ...
  var pn = Object.prototype.hasOwnProperty,
    Gn = D.unstable_scheduleCallback,
  ...
  var jt = Math.random().toString(36).slice(2),
    ...
    Ea = '__reactMarker$' + jt;
  function Cn(l) {
    (delete l[Rl], delete l[Xl], delete l[jn], delete l[Sy], delete l[gy]);
  }
  function Yu(l) {
    var t = l[Rl];
    if (t) return t;
...
` +
  ...
  function Mi(l, t, u) {
    ...
    try {
      ...
      if (
        ((Fn = !1),
        (Zu !== null || ju !== null) &&
          (hn(), Zu && ((t = Zu), (l = ju), (ju = Zu = null), _i(t), l)))
      )
  ...
  function Vi(l) {
    if (l.propertyName === 'value' && Ye(Ra)) {
      var t = [];
      (Qi(t, Ra, l, kn(l)), Mi(u1, t));
    }
  }
  function a1(l, t, u) {
    l === 'focusin'
  ...
  function bf(l) {
    for (; l === Qe; )
      ((Qe = Wu[--$u]), (Wu[$u] = null), (xe = Wu[--$u]), (Wu[$u] = null));
    for (; l === bu; )
      ((bu = nt[--ft]),
        (nt[ft] = null),
        (Ut = nt[--ft]),
  ...
  function qa(l) {
    ...
    if (
      ...
      t === 27
        ? ((t = yl), eu(l.type) ? ((l = Zc), (Zc = null), (yl = l)) : (yl = t))
        : (yl = pl ? ot(l.stateNode.nextSibling) : null);
    return !0;
  }
  function Ya() {
    ((yl = pl = null), (W = !1));
  ...
  var h1 =
    ...
    o1 = D.unstable_scheduleCallback,
    m1 = D.unstable_NormalPriority,
    Sl = {
      $$typeof: Ml,
      Consumer: null,
      Provider: null,
  ...
  var Iu = E(null),
    Ke = E(0);
  function b0(l, t) {
    ((l = Xt), z(Ke, l), z(Iu, t), (Xt = l | t.baseLanes));
  }
  function qf() {
    (z(Ke, Xt), z(Iu, Iu.current));
  }
  function Yf() {
    ((Xt = Ke.current), _(Iu), _(Ke));
  }
  var wt = 0,
    x = null,
    I = null,
  ...
  function T0(l) {
    ...
    if (((wt = 0), (ml = I = x = null), (Je = !1), (Va = 0), (la = null), t))
      throw Error(r(300));
    l === null ||
      Tl ||
  ...
  function Qf(l) {
    ...
    ((wt = 0), (ml = I = x = null), (Pu = !1), (Va = we = 0), (la = null));
  }
  function xl() {
    var l = {
      memoizedState: null,
  ...
  function A0(l, t, u) {
    ...
    if (
      ...
      if (
        ((a.flags |= 2048),
        ta(9, ke(), O0.bind(null, a, e, u, t), null),
        nl === null)
      )
        throw Error(r(349));
      n || (wt & 124) !== 0 || z0(a, t, u);
  ...
  function U0(l, t, u, a) {
    return ((l.baseState = u), jf(l, I, typeof a == 'function' ? a : Nt));
  }
  ...
  function G0(l, t, u) {
    ...
    return (
      u !== t.memoizedState &&
        ((x.flags |= 2048), ta(9, ke(), E1.bind(null, e, u), null)),
      [a, n, l]
    );
  }
  function E1(l, t) {
  ...
  function Fe(l, t, u, a) {
    ...
    ((a = a === void 0 ? null : a),
      (x.flags |= l),
      (e.memoizedState = ta(1 | t, ke(), u, a)));
  }
  function Ka(l, t, u, a) {
    var e = rl();
    a = a === void 0 ? null : a;
    var n = e.memoizedState.inst;
    I !== null && a !== null && Bf(a, I.memoizedState.deps)
      ? (e.memoizedState = ta(t, n, u, a))
      : ((x.flags |= l), (e.memoizedState = ta(1 | t, n, u, a)));
  }
  function x0(l, t) {
    Fe(8390656, 8, l, t);
  }
      ...
      if (
        ...
        try {
          ...
          if (((e.hasEagerState = !0), (e.eagerState = c), Wl(c, f)))
            return (pe(l, t, e, 0), nl === null && Be(), !1);
        } catch {
        } finally {
        }
    ...
    us = {
      ...
      useSyncExternalStore: function (l, t, u) {
        ...
        return (
          ...
          (a.flags |= 2048),
          ta(9, ke(), O0.bind(null, a, n, u, t), null),
          u
        );
      },
      useId: function () {
      ...
      useCacheRefresh: function () {
        return (xl().memoizedState = z1.bind(null, x));
      },
    },
    as = {
      readContext: Hl,
  ...
  function ln(l) {
    var t = wa;
    return ((wa += 1), ua === null && (ua = []), o0(ua, l, t));
  }
  function Wa(l, t) {
  ...
  function ns(l) {
    ...
    function m(y, v, d, b, M) {
      ...
      if (typeof b == 'object' && b !== null) {
        ...
        if (typeof b.then == 'function') return m(y, v, d, ln(b), M);
        if (b.$$typeof === Ml) return m(y, v, d, je(v, b), M);
        tn(v, b);
      }
      return null;
    }
    function p(y, v, d, b) {
      for (
        var M = null, Z = null, U = v, Y = (v = 0), Al = null;
        U !== null && Y < d.length;
        Y++
      ) {
    ...
    function q(y, v, d, b) {
      ...
      for (
        var M = null, Z = null, U = v, Y = (v = 0), Al = null, w = d.next();
        U !== null && !w.done;
        Y++, w = d.next()
      ) {
        U.index > Y ? ((Al = U), (U = null)) : (Al = U.sibling);
      ...
      if (w.done) return (u(y, U), W && Tu(y, Y), M);
      if (U === null) {
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = e),
            a !== Tf && ((l = Error(r(422), { cause: a })), Ba(at(l, u))))
          : (a !== Tf && ((t = Error(r(423), { cause: a })), Ba(at(t, u))),
  ...
  function Ss(l, t, u, a, e) {
    ...
    return (
      ...
      l !== null && !Tl
        ? (Xf(l, t, e), Yt(l, t, e))
        : (W && c && gf(t), (t.flags |= 1), zl(l, t, a, e), t.child)
    );
  }
  ...
  function Ts(l, t, u) {
    ...
    if (a.mode === 'hidden') {
      ...
      n !== null
        ? (Ce(t, n.cachePool), b0(t, n), $t(), (t.memoizedState = null))
        : (l !== null && Ce(t, null), qf(), $t());
  ...
  function Pf(l, t, u, a, e) {
    return (
      ...
      l !== null && !Tl
        ? (Xf(l, t, e), Yt(l, t, e))
        : (W && a && gf(t), (t.flags |= 1), zl(l, t, u, e), t.child)
    );
  }
  function As(l, t, u, a, e, n) {
    return (
      ...
      l !== null && !Tl
        ? (Xf(l, t, n), Yt(l, t, n))
        : (W && a && gf(t), (t.flags |= 1), zl(l, t, u, n), t.child)
    );
  }
  ...
  function Us(l, t, u) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Tl = !0;
        ...
        if (!fc(l, u) && (t.flags & 128) === 0) return ((Tl = !1), D1(l, t, u));
        Tl = (l.flags & 131072) !== 0;
      }
    ...
    switch (((t.lanes = 0), t.tag)) {
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              ((e = at(Error(r(424)), t)), Ba(e), (t = Os(l, t, a, u)));
              break l;
            } else {
      ...
      case 27:
        return (
          ...
          l === null &&
            ...
            (St = !0),
            (e = yl),
            eu(t.type) ? ((Zc = e), (yl = ot(a.firstChild))) : (yl = e)),
      ...
      case 5:
        return (
          ...
          t.memoizedState !== null &&
            ((e = pf(l, t, b1, null, null, u)), (ve._currentValue = e)),
          nn(l, t),
          zl(l, t, a, u),
          t.child
        );
        ...
        return (
          l === null &&
            ...
            ((l = u = yl) &&
              ...
              u !== null
                ? ((t.stateNode = u), (pl = t), (yl = null), (l = !0))
                : (l = !1)),
            l || Au(t)),
          null
        );
  ...
  function U1(l, t, u) {
    ...
    switch ((bf(t), t.tag)) {
      ...
      case 6:
        if (l && t.stateNode != null) l.memoizedProps !== a && Bt(t);
          ...
          if (((l = G.current), qa(t))) {
            ...
            ((l = En(l).createTextNode(a)), (l[Rl] = t), (t.stateNode = l));
        }
        return (vl(t), null);
      case 13:
        if (
      ...
      case 4:
        return (xt(), l === null && Nc(t.stateNode.containerInfo), vl(t), null);
      case 10:
        return (Ht(t.type), vl(t), null);
      case 19:
        if ((_(gl), (e = t.memoizedState), e === null)) return (vl(t), null);
      ...
      case 13:
        (Ft(l, u),
          ...
          a & 64 &&
            ...
            l !== null &&
              ((l = l.dehydrated),
              l !== null && ((u = x1.bind(null, u)), ad(l, u)))));
        break;
      case 22:
    ...
    for (e = e && (t.subtreeFlags & 10256) !== 0, t = t.child; t !== null; ) {
      ...
      switch (f.tag) {
        ...
        case 22:
          ...
          break;
        case 24:
          (ea(n, f, c, i, e), e && h & 2048 && hc(f.alternate, f));
          break;
        default:
          ea(n, f, c, i, e);
      }
  ...
  function Ls(l) {
    switch (l.tag) {
      ...
      case 4:
        var t = ht;
        ((ht = An(l.stateNode.containerInfo)), na(l), (ht = t));
        break;
      case 22:
        l.memoizedState === null &&
          ((t = l.alternate),
  ...
  function lt(l, t, u) {
    (((l === nl && (F === 2 || F === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ta(l, u),
      ((k & 2) === 0 || l !== nl) &&
        (l === nl && ((k & 2) === 0 && (Ru |= u), dl === 4 && au(l, V, it, !1)),
        Et(l)));
  }
  function ks(l, t, u) {
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = Sc + 300 - rt()), 10 < e)) {
            if ((au(a, t, it, !Pt), Ae(a, 0, !0) !== 0)) break l;
            a.timeoutHandle = _v(
              Fs.bind(null, a, u, jl, dn, rc, t, it, Ru, ca, Pt, n, 2, -0, 0),
              e,
            );
            break l;
          }
          Fs(a, u, jl, dn, rc, t, it, Ru, ca, Pt, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function Fs(l, t, u, a, e, n, f, c, i, h, S, T, o, m) {
    if (
      ...
      (T & 8192 || (T & 16785408) === 16785408) &&
        ((se = { stylesheets: null, count: 0, unsuspend: md }),
        Ls(t),
        (T = Sd()),
        T !== null))
    ) {
  ...
  function Ec() {
    if (j !== null) {
      ...
      else ((l = j), (Rt = zu = null), Qf(l), (ua = null), (wa = 0), (l = j));
          ...
          : (F =
              t === rs
                ...
                : t !== null &&
                  ...
                  : 1),
      (Il = t),
      j === null && ((dl = 1), en(l, at(t, l.current))));
  }
  function Ps() {
    var l = g.H;
  ...
  function ya(l, t, u, a) {
    ((Rt = zu = null), Qf(t), (ua = null), (wa = 0));
    var e = t.return;
    try {
      if (M1(l, e, t, u, V)) {
        ((dl = 1), en(l, at(u, l.current)), (j = null));
        return;
      }
    } catch (n) {
  ...
  function Oc(l, t, u) {
    ...
    e.has(u) ||
      ((oc = !0), e.add(u), (l = Q1.bind(null, l, t, u)), t.then(l, l));
  }
  function Q1(l, t, u) {
    var a = l.pingCache;
    (a !== null && a.delete(t),
      ...
      nl === l &&
        (V & u) === u &&
        (dl === 4 || (dl === 3 && (V & 62914560) === V && 300 > rt() - Sc)
          ? (k & 2) === 0 && va(l, 0)
          : (mc |= u),
        ca === V && (ca = 0)),
      Et(l));
  ...
  function yv(l, t) {
    (t === 0 && (t = ci()), (l = Ju(l, t)), l !== null && (Ta(l, t), Et(l)));
  }
  function x1(l) {
    var t = l.memoizedState,
      u = 0;
  ...
  function dv() {
    ...
    var l = 0;
    Hu !== 0 && (F1() && (l = Hu), (Hu = 0));
    for (var t = rt(), u = null, a = rn; a !== null; ) {
      var e = a.next,
        n = hv(a, t);
      (n === 0
        ? ((a.next = null),
  ...
  for (var Uc = 0; Uc < df.length; Uc++) {
    var Rc = df[Uc],
      K1 = Rc.toLowerCase(),
      J1 = Rc[0].toUpperCase() + Rc.slice(1);
    dt(K1, 'on' + J1);
  }
...
`,
              ...
              case 3:
                if (((n = n.stateNode), n.current.memoizedState.isDehydrated)) {
                  ...
                  if (f !== 0) {
                    ...
                    (Et(n), (k & 6) === 0 && ((yn = rt() + 500), ae(0)));
                  }
                }
                break;
              case 13:
                ((c = Ju(n, 2)), c !== null && lt(c, n, 2), hn(), Lc(n, 2));
            }
  ...
  function Hn(l, t) {
    l.blockedOn === t &&
      ...
      Wc ||
        ((Wc = !0),
        D.unstable_scheduleCallback(D.unstable_NormalPriority, Od)));
  }
  var Nn = null;
  function wv(l) {
    Nn !== l &&
    ...
    (qn.prototype.unmount = $c.prototype.unmount =
      function () {
        ...
        if (l !== null) {
          ...
          (Zv(l.current, 2, null, l, null, null), hn(), (t[qu] = null));
        }
      }));
  function qn(l) {
    this._internalRoot = l;
...
function pd() {
  ...
  return (D(), (Ic.exports = Bd()), Ic.exports);
}
var Gd = pd();
const Xd = async () => (await fetch('/users')).json(),
  Qd = async () => (await fetch('/accounts')).json(),
  xd = async () => (await fetch('/creditCards')).json(),
  Zd = () => {
    const [D, sl] = Se.useState([]),
      [$, r] = Se.useState([]),
      [Q, L] = Se.useState([]);
    return (
      Se.useEffect(() => {
      ...
      Sa.jsxs('div', {
        children: [
          Sa.jsxs('h1', { children: ['hello hello hello ', D.length] }),
          Sa.jsxs('h1', { children: ['hello hello hello ', $.length] }),
          Sa.jsxs('h1', { children: ['hello hello hello ', Q.length] }),
        ],
      })
    );
  },
  ...
  Cd = Gd.createRoot(jd);
Cd.render(Sa.jsx(Se.StrictMode, { children: Sa.jsx(Zd, {}) }));
